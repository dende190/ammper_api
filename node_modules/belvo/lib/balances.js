 ...
 * @extends Resource
 */
var Balance = /*#__PURE__*/function (_Resource) {
  _inherits(Balance, _Resource);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                account = options.account, token = options.token, encryptionKey = options.encryptionKey, saveData = options.saveData;
