          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                token = options.token, encryptionKey = options.encryptionKey, usernameType = options.usernameType, username2 = options.username2, username3 = options.username3, password2 = options.password2, accessMode = options.accessMode, externalId = options.externalId;
